        ...
        <main className="container mx-auto px-4 py-8">
          ...
          <section id="tamogatokEsPartnerek" ref={sectionRefs.tamogatokEsPartnerek} className="mb-12">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
              {[
                { name: "Chernel István Si és Turisztikai Klaszter", url:  "http://www.sieljitthon.hu/", img: "/placeholder.svg?height=100&width=100" },
                { name: "Magyar Sí Szövetség", url:  "http://www.skihungary.hu/", img: "/placeholder.svg?height=100&width=100"  },
                { name: "Síoktatók Magyarországi Szövetsége", url: "https://www.sioktatok.hu/", img: "/placeholder.svg?height=100&width=100"  },
                { name: "Sípark Mátraszentitván", url: "https://sipark.hu/", img: "/placeholder.svg?height=100&width=100"  },
                { name: "Skioutlet.hu", url: "https://www.skioutlet.hu/", img: "/placeholder.svg?height=100&width=100"  },
                { name: "Vadon  Sport",   url: "https://www.vadonsport.hu/", img: "/placeholder.svg?height=100&width=100"  },
                { name: "Marosport /FUNDANGO", url: "https://www.fundango.hu/", img: "/placeholder.svg?height=100&width=100"  },
                { name: "Tandtsport Sí és Snowboard Központ", url: "https://tandtsport.hu/", img: "/placeholder.svg?height=100&width=100"  },
                { name: "Csáki-Maronyák Éva festőművész", url: "#", img: "/placeholder.svg?height=100&width=100"  },
                { name: "Osztrák Idegenforgalmi Képviselet", url: "https://www.austria.info/hu", img: "/placeholder.svg?height=100&width=100"  },
                { name: "Lengyel Idegenforgalmi Szervezet", url: "https://www.lengyelorszag.travel/hu", img: "/placeholder.svg?height=100&width=100"  },
                { name: "Mondial Assistance", url: "https://www.mondial-assistance.hu/", img: "/placeholder.svg?height=100&width=100"  },
                { name: "Síelők.hu", url: "https://sielok.hu/", img: "/placeholder.svg?height=100&width=100"  },
                { name: "Magyar Vitorlás Szövetség", url: "https://www.hunsail.hu/", img: "/placeholder.svg?height=100&width=100"  },
                { name: "Nagyvillám Visegrádi sípálya", url: "https://nagyvillam.hu/", img: "/placeholder.svg?height=100&width=100"  }
              ].map((partner, index) => (
                <a
                  key={index}
                  href={partner.url}
